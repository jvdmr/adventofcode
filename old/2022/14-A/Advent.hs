...
findDup maxy (a@(_, y):b:rest) | y > maxy = Abyss
                               | a == b = Sand a
                               | otherwise = findDup maxy (b:rest)

intoTheAbyss :: CaveItem -> Bool
intoTheAbyss Abyss = True
intoTheAbyss _ = False
...
fall from cave | intoTheAbyss result = traceCave from cave
